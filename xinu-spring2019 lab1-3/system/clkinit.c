...
volatile uint32	clktimefine;
volatile uint32  initialtime;
...
void	clkinit(void)
{
	...
	clktimefine = 0; /* cutz - Initializing clktimefine (clktime in ms) */

	initialtime = 0; /* cutz - Initializing CPU usage global variable */
